...
const { couress } = useContext(MoviesContext)
 ...
 const [currentSlide, setCurrentSlide] = useState(0);
    ...
    const slides = [
        { image: Image.caroussel, alt: 'Slide 1' },
        { image: Image.caroussel2, alt: 'Slide 2' },
        { image: Image.caroussel3, alt: 'Slide 3' },
    ];
  ...
  return (
    ...
    <section>
{/* caroussel */}
 <div className="relative w-full h-[600px]  overflow-hidden rounded-lg z-10 mt-0.5">
